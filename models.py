...
class EmpDetails(models.Model):
    emp_id = models.AutoField(db_column='EMP_ID', primary_key=True, blank=True, null=True)  # Field name made lowercase.
    fullname = models.CharField(blank=True, null=True)
    address = models.CharField(blank=True, null=True)
    dob = models.CharField(db_column='Dob', blank=True, null=True)  # Field name made lowercase.
    ...
    date_of_joining = models.CharField(db_column='Date_of_Joining', blank=True, null=True)  # Field name made lowercase.
    ...
    date_of_resigning = models.CharField(db_column='Date_of_resigning', blank=True, null=True)  # Field name made lowercase.
    ...
    account_number = models.CharField(db_column='Account_Number', blank=True, null=True)  # Field name made lowercase.
...
class Program(models.Model):
    ...
    date = models.CharField(db_column='Date', blank=True, null=True)  # Field name made lowercase.
...
class Xref(models.Model):
    ...
    project_name = models.CharField(db_column='Project_name', blank=True, null=True)  # Field name made lowercase.
